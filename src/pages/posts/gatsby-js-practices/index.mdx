...
<Sidenote sidenote={'我也不太清楚 🤦🏻‍♂️'}>你知道 <InlineCode>npm install --save</InlineCode> 和 <InlineCode>npm install --save-dev</InlineCode> 的区别和用法吗？</Sidenote>
...
<Sidenote sidenote={<>以下代码涉及其他文件，仅供思路参考，所有源码请前往 <a href="https://github.com/DezineLeo/dezineleo-site" target="_blank">GitHub</a> 查看。</>}>
...
<Code lang="js" code={SidenoteCode} />
